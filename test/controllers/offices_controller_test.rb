...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { comment: @office.comment, latitude: @office.latitude, longitude: @office.longitude, name: @office.name }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { comment: @office.comment, latitude: @office.latitude, longitude: @office.longitude, name: @office.name }
    assert_redirected_to office_path(assigns(:office))
  end
